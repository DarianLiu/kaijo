...
@ActivityScope
public class InfoEditPresenter extends BasePresenter<InfoEditContract.Model, InfoEditContract.View> {
    @Inject
    ...
    @Inject
    public InfoEditPresenter(InfoEditContract.Model model, InfoEditContract.View rootView) {
