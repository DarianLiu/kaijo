...
//                }
    ...
    @OnClick({R.id.btn_location_obtain,R.id.tv_add_equipment, R.id.btn_submit_pic, R.id.btn_submit_check_record, R.id.submit})
            ...
            case R.id.submit:
                if (mPresenter != null) {
                    if (checkParams()) {
                        ...
                        mPresenter.insertInfo(streetId, communityId, String.valueOf(userInfo.getGridId()), String.valueOf(lat), String.valueOf(lng), photos, checkRecord, et_name.getText().toString(), tezhongshebei, et_farenName.getText().toString(), et_address.getText().toString());
                    }
