...
public interface InspectionAddContract {
    ...
    interface View extends IView {
        void httpInspectionSuccess(List<Inspection> inspectionList);
        void httpAddInspectionSuccess(Inspection inspection);
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResult<Inspection>> addOrUpdateThingPosition(int thingId,String name,Double lat,Double lng,int streetId,int communityId,int gridId,String createUser);
