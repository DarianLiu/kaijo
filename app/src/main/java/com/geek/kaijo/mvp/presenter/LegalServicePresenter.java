 ...
 */
@ActivityScope
public class LegalServicePresenter extends BasePresenter<LegalServiceContract.Model, LegalServiceContract.View> {
    @Inject
    ...
    @Inject
    public LegalServicePresenter(LegalServiceContract.Model model, LegalServiceContract.View rootView) {
