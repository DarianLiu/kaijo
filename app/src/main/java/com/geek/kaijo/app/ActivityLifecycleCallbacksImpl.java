...
public class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityStarted(Activity activity) {
        ...
        boolean isInitToolbar = activity.getIntent().getBooleanExtra("isInitToolbar", false);
        if (!isInitToolbar) {
            ...
            if (activity.findViewById(R.id.toolbar) != null) {
                if (activity instanceof AppCompatActivity) {
                    ...
                    ((Toolbar) activity.findViewById(R.id.toolbar)).setNavigationOnClickListener(
...
//                        ((android.widget.Toolbar) activity.findViewById(R.id.toolbar)).setNavigationOnClickListener(
//                                v -> activity.onBackPressed());
//                    }
//                }
            }
