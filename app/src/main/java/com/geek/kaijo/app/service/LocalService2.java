...
//        locParam.setForceUseWifi(true);
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<LocalService2> weakTrainModelActivity;

        public MyHandler(LocalService2 activity) {
            weakTrainModelActivity = new WeakReference<LocalService2>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            LocalService2 weakActivity;
